...
public class WordSearch extends Canvas {
  ...
  */
  public static void main(String[] args) {
    ...
    f.setPreferredSize(new Dimension(cGRIDWIDTH * cCELLWIDTH, cGRIDHEIGHT * cCELLHEIGHT));
    f.setMaximumSize(new Dimension(cGRIDWIDTH * cCELLWIDTH, cGRIDHEIGHT *cCELLHEIGHT));
    f.setMinimumSize(new Dimension(cGRIDWIDTH * cCELLWIDTH, cGRIDHEIGHT * cCELLHEIGHT));
    f.pack();
    f.setVisible(true);
  }
}
